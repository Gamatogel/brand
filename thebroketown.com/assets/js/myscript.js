...
$(document).ready(function() {
	...
	$(".services_list a").hover(
		function () {
			$('.services_list a').removeClass("active");
				$(this).addClass("active");
			}
		);
});
...
/*-----------------------------------------------------------------------------------*/
jQuery(document).ready(function() {
	$.getJSON("https://web.archive.org/web/20250107015913/http://api.flickr.com/services/feeds/photos_public.gne?id=90412460@N00&lang=en-us&format=json&jsoncallback=?", function(data){
...
playback timings (ms):
  ...
  esindex: 0.023
  cdx.remote: 63.064
  LoadShardBlock: 734.01 (3)
  PetaboxLoader3.resolve: 540.711 (4)
  PetaboxLoader3.datanode: 447.491 (4)
  load_resource: 279.268
*/